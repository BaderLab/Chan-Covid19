...
#   data_gisaid_week1 = selectdata(dstart="2021-02-01", dend ="2021-02-07", data = data_gisaid_sel)
#   length(names(data_gisaid_week1))
#writeXStringSet(data_gisaid_week1, '/Users/veroniquevoisin/Downloads/data_gisaid_week1.fa') #
#   data_gisaid_week4 = selectdata(dstart="2021-02-23", dend ="2021-02-28", data = data_gisaid_sel)
